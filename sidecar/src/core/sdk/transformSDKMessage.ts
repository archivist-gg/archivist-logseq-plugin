...
/** Error variant of SDKResultMessage (subtype !== 'success'). */
type SDKResultError = {
  type: 'result';
...
import type { SDKToolUseResult, UsageInfo } from '../types/index.js';
import { getContextWindowSize } from '../types/index.js';
import { isBlockedMessage } from '../types/sdk.js';
import { extractToolResultContent } from './toolResultContent.js';
