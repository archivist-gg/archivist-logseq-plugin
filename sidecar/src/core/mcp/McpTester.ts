...
import { getEnhancedPath } from '../utils/env.js';
import { parseCommand } from '../utils/mcp.js';
import type { ClaudianMcpServer } from '../types/index.js';
import { getMcpServerType } from '../types/index.js';
...
async function getRequestBody(body: unknown): Promise<Buffer | undefined> {
  ...
  // Fallback: try to serialize via JSON
