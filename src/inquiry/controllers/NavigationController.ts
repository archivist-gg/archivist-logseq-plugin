/**
 * NavigationController — Vim-style keyboard navigation for chat panel.
 *
 * Ported from Obsidian's NavigationController.
 * Replaces Obsidian `Scope` with plain `addEventListener('keydown', ...)`.
 */
...
export class NavigationController {
  ...
  initialize(): void {
    ...
    messagesEl.classList.add('claudian-messages-focusable');
  ...
  dispose(): void {
    ...
    messagesEl?.classList.remove('claudian-messages-focusable');
