...
This project is indexed by GitNexus as **archivist-logseq** (1050 symbols, 3181 relationships, 87 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/archivist-logseq/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/archivist-logseq/context` | Codebase overview, check index freshness |
| `gitnexus://repo/archivist-logseq/clusters` | All functional areas |
| `gitnexus://repo/archivist-logseq/processes` | All execution flows |
| `gitnexus://repo/archivist-logseq/process/{name}` | Step-by-step execution trace |
